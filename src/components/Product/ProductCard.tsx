...
const ProductCard = ({ badge, itemData, classNames }: ProductCardProps) => {
  ...
  return (
    ...
    >
      ...
      <CardContent className='p-0 w-full rounded-lg border-none'>
        <Image src='/images/pizza.png' width={300} height={200} className='flex flex-1 w-full mb-4' alt='Img' />
          ...
          <div className='flex flex-row justify-between gap-1'>
            <div className='flex gap-2'>
              {[...Array(3)].map((_i, index) => (
                <Circle key={index} color={type === "yellow" ? "#EDDB75" : undefined} />
              ))}
            </div>
            <div className='flex gap-2'>
              <p>{weight}гр.</p>
